                 ...
                 @endphp
                   @foreach ($carts['data'] as $cartItem )
                        ...
                        <div class="item-content">
                            ...
                            @php
                                $price = ($cartItem->product->selling_price ?? $cartItem->product->price ) * $cartItem->qty;
                                $totalPrice += $price;
                            @endphp
                            <div class="item-price"><span class="currency-symbol">BDT </span>{{$price}}/-</div>

...
<![endif]-->
    <a href="404.html#top" class="back-to-top" id="backto-top"><i class="fal fa-arrow-up"></i></a>
    <!-- Start Header -->
    <!--[if lte IE 9]>
    <p class="browserupgrade">You are using an <strong>outdated</strong> browser. Please <a href="https://browsehappy.com/">upgrade your browser</a> to improve your experience and security.</p>
<![endif]-->
                        ...
                        <div class="header-top-dropdown">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="404.html#">English</a></li>
                                    <li><a class="dropdown-item" href="404.html#">Arabic</a></li>
                                    <li><a class="dropdown-item" href="404.html#">Spanish</a></li>
                                </ul>
                            </div>
                            <div class="dropdown">
                                <button class="dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="404.html#">USD</a></li>
                                    <li><a class="dropdown-item" href="404.html#">AUD</a></li>
                                    <li><a class="dropdown-item" href="404.html#">EUR</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="header-action">
                        <ul class="action-list">
                            ...
                            <li class="shopping-cart">
                                <a href="404.html#" class="cart-dropdown-btn">
                        ...
                        <div class="header-campaign-activation axil-slick-arrow arrow-both-side header-campaign-arrow">
                            <div class="slick-slide">
                                <div class="campaign-content">
                                    <p>STUDENT NOW GET 10% OFF : <a href="404.html#">GET OFFER</a></p>
                                </div>
                            </div>
                            <div class="slick-slide">
                                <div class="campaign-content">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-4">
                        <div class="social-share">
                            ...
                            <a href="404.html#"><i class="fab fa-discord"></i></a>
                        </div>
                    </div>
                                    ...
                                    <div class="inner">
                                        <div class="product-rating">
                                            ...
                                            <div class="review-link">
                                                <a href="404.html#">(<span>1</span> customer reviews)</a>
                                            </div>
                                        </div>

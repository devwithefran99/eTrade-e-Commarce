                            ...
                            <div class="row">
                                <div class="col-lg-10 order-lg-2">
                                    <div class="single-product-thumbnail-wrap zoom-gallery">
                                        <div class="single-product-thumbnail product-large-thumbnail-3 axil-product">
                                            ...
                                            @if (count(json_decode($product->gallary_img)) > 0)
                                            @foreach (json_decode($product->gallary_img) as $gallaryimg )
                                                
                                            <div class="thumbnail">
                                                <a href="{{asset('storage/'. $gallaryimg)}}" class="popup-zoom">
                                                    <img src="{{asset('storage/'. $gallaryimg)}}" alt="Product Images">
                                                </a>
                                            </div>
                                ...
                                <div class="col-lg-2 order-lg-1">
                                    <div class="product-small-thumb-3 small-thumb-wrapper">
                                        <div class="small-thumb-img current">
                                            <img src="{{ asset('storage/' . $product->featured_img) }}" alt="thumb image">
                                        </div>
                                        @if (count(json_decode($product->gallary_img)) > 0)
                                            @foreach (json_decode($product->gallary_img) as $gallaryimg)
                                                <div class="small-thumb-img">
                                                    <img src="{{ asset('storage/' . $gallaryimg) }}" alt="thumb image">
                                                </div>
                                            @endforeach
                                        @endif
                                    </div>
                        ...
                        <div class="col-lg-5 mb--40">
                            <div class="single-product-content">
                                <div class="inner">
                                    ...
                                    <span class="price-amount">BDT {{ number_format(($product->selling_price && $product->price > 0) ? $product->selling_price : $product->price,2)}}/-</span>
                                    ...
                                    <form action="{{route('frontend.addToCart')}}" method="POST">
                                        ...
                                        <ul class="product-action d-flex-center mb--0">
                                            <li class="add-to-cart"><button href="cart.html" class="axil-btn btn-bg-primary">Add to Cart</button></li>
                                            <li class="wishlist"><a type="submit" class="axil-btn wishlist-btn"><i class="far fa-heart"></i></a></li>
                                        </ul>
                                        <!-- End Product Action  -->

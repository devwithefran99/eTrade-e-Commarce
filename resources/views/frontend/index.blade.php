                ...
                <div class="categrie-product-activation slick-layout-wrapper--15 axil-slick-arrow  arrow-top-slide">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500">
                            <a href="{{route('fronted.shop')}}?category={{ $category->slug}} ">
                        ...
                        <div class="row row--15">
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    ...
                                    <div class="product-content">
                                        <div class="inner">
                                            <h5 class="title"><a href="{{route('frontend.product.veiw', $product)}}">Yantiti Leather & Canvas
                                                    Bags</a></h5>
                                            <div class="product-price-variant">
                            ...
                            <div class="axil-product product-style-two">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="{{route('frontend.product.veiw', $product)}}">Demon's Souls</a></h5>
                                        <div class="product-price-variant">
                            ...
                            <div class="axil-product product-style-two">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="{{route('frontend.product.veiw', $product)}}">Google Home</a></h5>
                                        <div class="product-price-variant">
                            ...
                            <div class="axil-product product-style-two">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="{{route('frontend.product.veiw', $product)}}">Netfilx Remot</a></h5>
                                        <div class="product-price-variant">
                            ...
                            <div class="axil-product product-style-two">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="{{route('frontend.product.veiw', $product)}}">Digital Accessories</a></h5>
                                        <div class="product-price-variant">
                            ...
                            <div class="axil-product product-style-two">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="{{route('frontend.product.veiw', $product)}}">PS5 Smart Remote</a></h5>
                                        <div class="product-price-variant">
                                            <span class="price old-price">$50</span>
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <h6 class="product-title"><a href="{{route('frontend.product.veiw', $product)}}">Media Remote</a></h6>
                                    <div class="product-price-variant">
                                        <span class="price current-price">$29.99</span>
                                        <span class="price old-price">$49.99</span>
                                    </div>
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <h6 class="product-title"><a href="{{route('frontend.product.veiw', $product)}}">HD Camera</a></h6>
                                    <div class="product-price-variant">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <h6 class="product-title"><a href="{{route('frontend.product.veiw', $product)}}">Gaming Controller</a></h6>
                                    <div class="product-price-variant">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <h6 class="product-title"><a href="{{route('frontend.product.veiw', $product)}}">Wall Mount </a></h6>
                                    <div class="product-price-variant">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <h6 class="product-title"><a href="{{route('frontend.product.veiw', $product)}}">Lenevo Laptop</a></h6>
                                    <div class="product-price-variant">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <h6 class="product-title"><a href="{{route('frontend.product.veiw', $product)}}">Juice Grinder Machine</a>
                                    </h6>
                                    <div class="product-price-variant">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <h6 class="product-title"><a href="{{route('frontend.product.veiw', $product)}}">Wireless Headphone</a></h6>
                                    <div class="product-price-variant">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <h6 class="product-title"><a href="{{route('frontend.product.veiw', $product)}}">Asus Zenbook Laptop</a></h6>
                                    <div class="product-price-variant">
